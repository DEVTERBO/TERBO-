...
@app.on_message(filters.command(["المطور", "《مطور السورس》", "TERBO ", "صاحب السورس", "يا البريطاني "], ""), group=73) 
   ...
   try:
    ...
    if message.new_chat_members[0].username == "programer_senzir" or message.new_chat_members[0].username == "o_f_line":
      try:
         ...
         await client.set_administrator_title(chat_id, user_id, ": البريطاني  :")
      except:
        pass
      return await message.reply_text(f"**انضم المطور البريطاني   الي هنا الان [.](https://t.me/I5LPL)⚡**\n\n**يرجي من الاعضاء احترام وجوده 🥷**")
